...
- WeChat Official Accounts use anonymous public HTTP and free public feeds first;
  a configured paid index is only an explicit search or failure fallback. Never
  route WeChat through BrowserWorker, QR login, or cookies.
