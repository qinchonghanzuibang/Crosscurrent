...
Crosscurrent is an independent, native personal intelligence feed for macOS. It
...
Crosscurrent is being built for macOS 15 and later on Apple silicon. The repository
...
reference for native feed UX and modular desktop architecture. Crosscurrent is an
