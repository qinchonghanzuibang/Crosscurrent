...
public enum CrosscurrentStorageError: LocalizedError, Equatable {
    ...
    public var errorDescription: String? {
        ...
        case let .incompatibleSchema(found, required):
            "Waiting for Crosscurrent to migrate/update (database schema \(found), required \(required))."
        case .migrationRequiresMainApp:
        ...
        case .databaseNotInitialized:
            "Waiting for Crosscurrent to create the canonical database."
...
public struct DatabaseLocations: Sendable {
    ...
    public var canonicalDatabase: URL { container.appending(path: "Canonical/Crosscurrent.sqlite") }
    ...
    public static func appGroup(identifier: String = "group.com.chonghanqin.crosscurrent") throws -> Self {
