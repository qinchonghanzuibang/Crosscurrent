...
/// The only writer of Today revisions. Both FeedFlow and Agent call this actor through the same
...
public actor TodayCoordinator {
    ...
    public init(repository: FeedFlowRepository, calendar: Calendar = .autoupdatingCurrent) {
