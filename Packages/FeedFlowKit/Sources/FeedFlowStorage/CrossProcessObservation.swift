...
private func feedFlowDarwinChangeName() -> CFString {
    "com.chonghanqin.feedflow.database.changed" as CFString
}

private func feedFlowDarwinCallback(
...
public final class CrossProcessObservationHub: @unchecked Sendable {
    ...
    public func start() {
        ...
        CFNotificationCenterAddObserver(
            ...
            feedFlowDarwinCallback,
            feedFlowDarwinChangeName(),
            nil,
            .deliverImmediately
        )
    }
    ...
    public func postWakeHint() {
        CFNotificationCenterPostNotification(
            CFNotificationCenterGetDarwinNotifyCenter(),
            CFNotificationName(feedFlowDarwinChangeName()),
            nil,
            nil,
            true
        )
